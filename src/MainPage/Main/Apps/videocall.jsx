            ...
            <div className="chat-window video-window">
              <div className="fixed-header">
                <ul className="nav nav-tabs nav-tabs-bottom">
                  <li className="nav-item"><a className="nav-link active" href="#calls_tab" data-bs-toggle="tab">Calls</a></li>
                  <li className="nav-item"><a className="nav-link" href="#chats_tab" data-bs-toggle="tab">Chats</a></li>
                  <li className="nav-item"><a className="nav-link" href="#profile_tab" data-bs-toggle="tab">Profile</a></li>
                </ul>
              </div>
